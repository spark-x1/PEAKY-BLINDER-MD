...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍᴅ", // Bot display name
  MODE: getConfig("MODE") || process.env.MODE || "private", // Bot mode: public/private/group/inbox
  REPO: process.env.REPO || "https://github.com/Thomas-shelby001/PEAKY-BLINDER-MD", // Bot GitHub repo dont change this❗️
  ...
  OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "𝚂𝚊𝚗𝚐 𝙻𝚎𝚎", // Owner name
...
// add alive msg here 
  ...
  STICKER_NAME: process.env.STICKER_NAME || "𝙿𝙴𝙰𝙺𝚈-𝙱𝙻𝙸𝙽𝙳𝙴𝚁-𝙼𝙳", // Sticker pack name
