...
const ALIVE_IMG = "https://files.catbox.moe/018gb0.png";
...
lee({
    ...
    try {
        ...
        const msg = `
╭──❖ 「 *${toTinyCap("𝙿𝙴𝙰𝙺𝚈-𝙱𝙻𝙸𝙽𝙳𝙴𝚁-𝙼𝙳 status")}* 」 ❖─
│
│ 👤 ʜɪ: *${pushname}*
│ 🕓 ᴛɪᴍᴇ: *${currentTime}*
│ 📆 ᴅᴀᴛᴇ: *${currentDate}*
...
✅ *𝙿𝙴𝙰𝙺𝚈-𝙱𝙻𝙸𝙽𝙳𝙴𝚁-𝙼𝙳 is alive & operational!*
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '𝙿𝙴𝙰𝙺𝚈-𝙱𝙻𝙸𝙽𝙳𝙴𝚁-𝙼𝙳 ᴀʟɪᴠᴇ',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
